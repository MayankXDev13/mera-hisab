...
describe("004 - validation + actor + dto", () => {
  ...
  it("toIso and availablePaise guarantees", () => {
    ...
    expect(toTransactionDto({ id: "1", direction: "debit", amountPaise: 500, customerId: "c", sourceId: "s", occurredAt: now, note: null, createdBy: null, createdAt: now }).occurredAt).toBe(now.toISOString());
  });
